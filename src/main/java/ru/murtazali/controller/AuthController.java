...
import ru.murtazali.security.AuthService;
import ru.murtazali.service.dto.user.UserDTO;
import ru.murtazali.service.UserService;
import ru.murtazali.validator.UserValidator;
...
public class AuthController {
    ...
    public String toRegister(@ModelAttribute UserDTO userDTO, BindingResult bindingResult, ModelMap map){
        userDTO.setIdRole(userService.getRole(3).getId());
        ...
        authService.authWithAuthManager(userDTO);
